...
export const dict = {
  en: {
    ...
    ga_tab_tags: 'App Tags',
    ga_tags_desc: 'Manage tags for your apps. You can request existing tags or apply for custom ones.',
    ga_request_tag: 'Request Tag',
    ga_custom_tag: 'New Custom Tag',
    ga_tag_name_or_select: 'Select or enter new tag name',
    ...
    consent_subtitle: 'is requesting access to your account',
    consent_logged_in_as: 'Signed in as',
    consent_scopes_label: 'This will allow the application to:',
    consent_scope_openid: 'Verify your identity (subject identifier)',
    consent_scope_profile: 'Access your profile (name, username, picture)',
    consent_scope_email: 'Access your email address',
    consent_scope_offline_access: 'Maintain access while you are offline (refresh token)',
    ...
    label_initiate_login_uri: 'Initiate Login URI (OIDC)',
    help_initiate_login_uri: 'Optional. The RP\'s login initiation endpoint. If empty, Base URL is used for dashboard links.',
    ...
    tags_header: 'Tag Management',
    tags_subtitle: 'Manage global tags and approve group tag requests',
    btn_add_tag: 'New Tag',
    label_tag_name: 'Tag Name',
    ph_tag_name: 'e.g. Official',
    confirm_delete_tag: 'Delete this tag? All app associations will be removed.',
    none_tags: 'No tags found.',
    tag_status_active: 'Active',
    tag_status_pending: 'Pending Approval',
    tag_status_rejected: 'Rejected',
    tag_owner: 'Owner Group',
    btn_attach_app: 'Attach App',
    confirm_remove_app_tag: 'Remove this tag from the app?',
    tag_apps_header: 'Attached Apps',
    none_tag_apps: 'No apps attached.',
    tag_app_requests_header: 'Pending Tag Requests',
    tag_create_requests_header: 'Pending Custom Tag Requests',
  ...
  ja: {
    ...
    ga_tab_tags: 'アプリタグ',
    ga_tags_desc: '自グループのアプリに付けるタグを管理します。既存タグの紐付け申請や、独自のタグ作成申請が行えます。',
    ga_request_tag: 'タグ申請',
    ga_custom_tag: '新しい独自タグを作成',
    ga_tag_name_or_select: '既存タグを選択、または新しいタグ名を入力',
    ...
    // OIDC consent screen
    consent_title: 'アクセスの許可',
    consent_subtitle: 'があなたのアカウントへのアクセスを求めています',
    consent_logged_in_as: 'ログイン中:',
    consent_scopes_label: 'このアプリに以下を許可します:',
    consent_scope_openid: 'あなたの識別子(sub)を確認する',
    consent_scope_profile: 'プロフィール(氏名・ユーザー名・画像)を参照する',
    consent_scope_email: 'メールアドレスを参照する',
    consent_scope_offline_access: 'オフライン時もアクセスを維持する(リフレッシュトークン)',
    consent_approve: '許可する',
    consent_deny: '拒否する',
    title_signup: '新規登録',
    signup: '新規登録',
    ...
    label_initiate_login_uri: 'ログイン開始URI (OIDC)',
    help_initiate_login_uri: '任意。ダッシュボード等からのログイン開始時に送られるエンドポイントです。未設定時はベースURLが使われます。',
    ...
    tags_header: 'タグ管理',
    tags_subtitle: 'システム全体で利用可能なタグと、グループからのタグ申請を管理します',
    btn_add_tag: '新規タグ',
    label_tag_name: 'タグ名',
    ph_tag_name: '例: 公式アプリ',
    confirm_delete_tag: 'このタグを削除しますか？\n全てのアプリとの紐付けも解除されます。',
    none_tags: 'タグがありません',
    tag_status_active: '有効',
    tag_status_pending: '承認待ち',
    tag_status_rejected: '却下',
    tag_owner: '所有グループ',
    btn_attach_app: 'アプリを紐付け',
    confirm_remove_app_tag: 'アプリからこのタグを外しますか？',
    tag_apps_header: '紐付けられたアプリ',
    none_tag_apps: '紐付けられたアプリはありません',
    tag_app_requests_header: '紐付け申請 (承認待ち)',
    tag_create_requests_header: '独自タグ作成申請 (承認待ち)',
    ...
    error_password_too_short: 'パスワードは8文字以上で入力してください',
